...
@IonicPage()
@Component({
  selector: 'page-bussiness-data',
  templateUrl: 'bussiness-data.html',
})
export class BussinessDataPage {
  public busd : any  = [];
  public logkey : any  = [];
  public buss : any  = [];
  public loguser : any  = [];
  ...
  ionViewWillEnter(){
    ...
    this.storage.get('user_data').then((val) => {
      ...
      let headers   : any      = new Headers({ 'Content-Type': "application/x-www-form-urlencoded; charset=UTF-8"}),
         key        : any   = this.logkey,
         jobd_api   : any     = {"api":"114","code":"101","type":"300","device_id":"1234568","key":key},
